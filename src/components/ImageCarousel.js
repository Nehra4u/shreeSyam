      ...
      <div className="carousel-container">
        <div className="carousel-header">
          <h2 className="carousel-title">
            <span className="divine-text">{t('carousel.title')}</span>
            <span className="english-text">{t('carousel.titleEnglish')}</span>
          </h2>
