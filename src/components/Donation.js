      ...
      <div className="donation-container">
        <div className="donation-header">
          <h2 className="donation-title">
            <span className="divine-text">दान</span>
            <span className="english-text">Donation</span>
          </h2>
          <p className="donation-subtitle">श्री श्याम मंदिर कमेटी को</p>
          <p className="donation-description">
            Online Donation देने के लिए दिए गए QR code को scan करें<br/>
            और अपनी इच्छा अनुसार दान करें ॥
          </p>
        </div>
